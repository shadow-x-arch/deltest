...
export const CarRentalPage: React.FC = () => {
  ...
  const filteredProducts = useMemo(() => {
    let filtered = products.filter(product => 
      product.category === 'Cars' && product.subcategory === 'Car Rental'
    );
    ...
    if (priceRange !== 'all') {
      if (priceRange === 'low') {
        ...
        filtered = filtered.filter(product => product.amount >= 100 && product.amount < 200);
            ...
            <div className="lg:col-span-3">
                ...
                <div className={`p-8 rounded-xl border bg-gradient-to-b from-blue-50 via-cyan-50 to-white dark:from-blue-900/30 dark:via-cyan-900/30 dark:to-gray-900 border-blue-200 dark:border-blue-700 relative overflow-hidden`}>
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className={`text-lg text-blue-700 dark:text-blue-300 opacity-90`}>
                          Flexible rental options for every journey and occasion
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                      {['Hourly & Daily', 'Airport Pickup', 'No Hidden Fees', 'Miles Rewards'].map((feature, index) => (
                    ...
                    <div className={`text-sm text-blue-700 dark:text-blue-300 opacity-70`}>
                      {filteredProducts.length} rental options available • Earn miles with every rental
                    </div>
                  </div>
              ...
              >
                <SearchBar
                  ...
                  placeholder="Search car rentals by type, location, or features..."
                />
              </motion.div>
              ...
              >
                <div className="flex flex-wrap gap-4 items-center">
                  ...
                  >
                    ...
                    <option value="high">Over $200/day</option>
                  </select>
              ...
              {filteredProducts.length === 0 && (
                ...
                >
                  ...
                  <h3 className="text-xl font-medium mb-2">No car rentals found</h3>
